...
function Hero() {
  return (
    <section id="home" className="flex flex-col items-center justify-center min-h-[70vh] text-center py-16">
      <img src="/assets/profile.jpg" alt="UmarSharook Gurramkonda" className="w-32 h-32 rounded-full shadow-lg mb-6 object-cover border-4 border-blue-600" />
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <a href="/assets/resume.pdf" download className="px-6 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700 transition">Download Resume</a>
